...
def PGE(portal):
    ...
    portal.fill_text_id('tpCompanyName','Solar Spectrum Inc.')
    portal.fill_text_id('tpEmail','forms@solarspectrum.com')
    portal.fill_text_id('tpConfirmEmail','forms@solarspectrum.com')
