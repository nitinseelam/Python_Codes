...
def PGEfinal(portal):
    ...
    if portal.data['fp.NAME'] in ['sungevity_cash','sungevity_sunrun_cash']:
        ...
        portal.fill_text_id('developerNameSale','Sungevity Inc.')
    ...
    portal.fill_text_id('installerCompanyName','Sungevity Inc.')
    ...
    portal.fill_text_id('contractorEmail1','forms@sungevity.com')
    ...
    portal.fill_text_id('preparerCompanyName', 'Sungevity, Inc.')
    ...
    portal.fill_text_id('listName','Sungevity Inc.')
    portal.click_id('btn-next-1')
